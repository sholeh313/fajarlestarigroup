...
public class ListContactCustomer extends Activity {
	private Context act;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_list_contact_customer);
	...
	private void gotoPilihanContact() {
		Intent i = new Intent(this, PilihanContactUnused.class);
		startActivity(i);
		finish();
	}
	...
	public void gotoDetailCustomer() {
		Intent i = new Intent(this, DetailContactCustomer.class);
		startActivity(i);
		finish();
	}
